...
var Ci = Symbol("_handleChunk");
var ki = Symbol("_makeBuf");
var ie = Symbol("_mode");
...
var Gi = Symbol("nextEntry");
var Ws = Symbol("processEntry");
var V = Symbol("extendedHeader");
var he = Symbol("globalExtendedHeader");
var ft = Symbol("meta");
var Gs = Symbol("emitMeta");
var p = Symbol("buffer");
var it = Symbol("queue");
var dt = Symbol("ended");
var Zi = Symbol("emittedEnd");
var At = Symbol("emit");
var y = Symbol("unzip");
var $e = Symbol("consumeChunk");
var Xe = Symbol("consumeChunkSub");
var Yi = Symbol("consumeBody");
var Zs = Symbol("consumeMeta");
var Ys = Symbol("consumeHeader");
var ae = Symbol("consuming");
var Ki = Symbol("bufferConcat");
...
var ts = Symbol("symlink");
var tr = Symbol("hardlink");
var ce = Symbol("header");
var ei = Symbol("read");
var es = Symbol("lstat");
var ii = Symbol("onlstat");
var is = Symbol("onread");
var ss = Symbol("onreadlink");
var rs = Symbol("openfile");
var ns = Symbol("onopenfile");
var pt = Symbol("close");
var si = Symbol("mode");
var os = Symbol("awaitDrain");
...
var ue = Symbol("ended");
var W = Symbol("queue");
var me = Symbol("pendingLinks");
var Et = Symbol("current");
var Ct = Symbol("process");
var pe = Symbol("processing");
var hi = Symbol("processJob");
var G = Symbol("jobs");
var hs = Symbol("jobDone");
var li = Symbol("addFSEntry");
var sr = Symbol("addTarEntry");
var cs = Symbol("stat");
var fs = Symbol("readdir");
var ci = Symbol("onreaddir");
var fi = Symbol("pipe");
var rr = Symbol("entry");
var as = Symbol("entryOpt");
var di = Symbol("writeEntryClass");
var or = Symbol("write");
var ls = Symbol("ondrain");
...
var Tr = Symbol("onEntry");
var gs = Symbol("checkFs");
var xr = Symbol("checkFs2");
var bs = Symbol("isReusable");
var P = Symbol("makeFs");
var _s = Symbol("file");
var Os = Symbol("directory");
var Ri = Symbol("link");
var Lr = Symbol("symlink");
var Nr = Symbol("hardlink");
var ye = Symbol("ensureNoSymlink");
var Dr = Symbol("unsupported");
var Ar = Symbol("checkPath");
var Ss = Symbol("stripAbsolutePath");
var yt = Symbol("mkdir");
...
`);
    ...
    if (fs8.existsSync(pluginUiTarball)) {
      ...
      await uo({ file: pluginUiTarball, cwd: paths.ui });
    }
    ij.harnesses[INSTALL_KEY] = buildCopilotVscodePluginEntry(deliveringVersion);
    writeInstallJson(paths.installJson, ij);
